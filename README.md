...
[![Github Workflow](<https://github.com/trailheadapps/redwoods-insurance/workflows/Salesforce%20DX%20(scratch%20org)/badge.svg?branch=master>)](https://github.com/trailheadapps/redwoods-insurance/actions?query=workflow%3A%22Salesforce+DX+%28scratch+org%29%22)
...
4. Create a scratch org and provide it with an alias (redwoods-insurance):
...
6. Create a new Role named 'redwoods-insuranceAdjuster':
...
9. Assign the **redwoods_insurance_mobile** permission set to the default user:
