...
class AudioTranscriptionViewModel: NSObject, ObservableObject, AVAudioRecorderDelegate, AVAudioPlayerDelegate {

  let objectWillChange = PassthroughSubject<AudioTranscriptionViewModel, Never>()
